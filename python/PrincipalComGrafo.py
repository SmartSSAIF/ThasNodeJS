...
class Comunicacao(object):
    def __init__(self, hashLugares):
        self.x = 0
        self.hashLugares = hashLugares
    ...
    def pedido(self, lugar1,lugar2):
        split1 = (self.caminhoFinal(self.buscaCaminho(self.hashLugares[lugar1],self.hashLugares[lugar2],graph)))
        print("split")
        print(split1)
        split1 = split1.split(',')
        instrucoes = ""
...
listaArestas = {}
def addAresta(noa,nob,angulo=0,peso=1):
...
addAresta(hashLugares[("peteca"+str(16))],hashLugares[("peteca"+str(17))])
addAresta(hashLugares[("peteca"+str(1))],hashLugares[("peteca"+str(16))])
addAresta(hashLugares[("peteca"+str(0))],hashLugares[("peteca"+str(10))])
addAresta(hashLugares[("peteca"+str(1))],hashLugares[("peteca"+str(2))])
addAresta(hashLugares[("peteca"+str(3))],hashLugares[("peteca"+str(2))],90,2)
addAresta(hashLugares[("peteca"+str(3))],hashLugares[("peteca"+str(5))],-90,2)
addAresta(hashLugares[("peteca"+str(4))],hashLugares[("peteca"+str(5))],90,2)
addAresta(hashLugares[("peteca"+str(2))],hashLugares[("peteca"+str(4))],90,2)
addAresta(hashLugares[("peteca"+str(12))],hashLugares[("peteca"+str(3))])
addAresta(hashLugares[("peteca"+str(4))],hashLugares[("peteca"+str(13))])
addAresta(hashLugares[("peteca"+str(6))],hashLugares[("peteca"+str(5))])
addAresta(hashLugares[("peteca"+str(6))],hashLugares[("peteca"+str(7))],-90,2)
addAresta(hashLugares[("peteca"+str(9))],hashLugares[("peteca"+str(7))],90,2)
addAresta(hashLugares[("peteca"+str(9))],hashLugares[("peteca"+str(8))],-90,2)
addAresta(hashLugares[("peteca"+str(6))],hashLugares[("peteca"+str(8))],90,2)
addAresta(hashLugares[("peteca"+str(8))],hashLugares[("peteca"+str(15))])
addAresta(hashLugares[("peteca"+str(14))],hashLugares[("peteca"+str(7))])
addAresta(hashLugares[("peteca"+str(9))],hashLugares[("peteca"+str(10))])
addAresta(hashLugares[("peteca"+str(11))],hashLugares[("peteca"+str(10))])



for i in hashLugares:
    graph.addNo(hashLugares[i])
com = Comunicacao(hashLugares)
...
s = zerorpc.Server(Comunicacao(hashLugares))
